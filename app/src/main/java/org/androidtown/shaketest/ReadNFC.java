...
public class ReadNFC extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
         ...
         * 2. intent 값 지정
         */
        Intent intent = new Intent(ReadNFC.this, Second.class); //다른액티비티에서 처리할 경우에 이렇게 지정한다.
        //Intent intent = new Intent(this, getClass()).addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP); //이 문구는 현재 액티비티에서 해결할시에 사용한다.
        pendingIntent = PendingIntent.getActivity(ReadNFC.this, 0, intent, 0); //intent의 값을 넣는다. 이것을 다음 액티비티에 넘김으로써 다음 액티비티에서 처리가가능
