...
public class Card3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup mView = (ViewGroup) inflater.inflate(R.layout.card3, container, false);

        getPhonenum();
        getinfo();
        Toast.makeText(getActivity(), "" + userName + userPhoneNum + userEmail, Toast.LENGTH_SHORT).show();
        TextView name = (TextView) mView.findViewById(R.id.card3_name);
        TextView phone = (TextView) mView.findViewById(R.id.card3_phone_num);
        TextView email = (TextView) mView.findViewById(R.id.card3_email);
