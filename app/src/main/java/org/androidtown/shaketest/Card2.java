...
public class Card2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView name = (TextView) mView.findViewById(R.id.card2_name);
        TextView phone = (TextView) mView.findViewById(R.id.card2_phone_num);
        TextView email = (TextView) mView.findViewById(R.id.card2_email);
